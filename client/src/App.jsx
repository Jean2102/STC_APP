...
const NotificationInstructionsModal = ({ onClose }) => {
  return (
    <div style={styles.modalBackdrop}>
      <div style={styles.modalContent}>
        <h3>Activar Notificaciones Manualmente</h3>
        <p style={{marginBottom: '20px', lineHeight: 1.6}}>Tu navegador ha bloqueado las notificaciones. Para reactivarlas, sigue estos pasos:</p>
        <strong style={{display: 'block', marginTop: '10px'}}>En Chrome (Android):</strong>
        <ol style={{paddingLeft: '20px', fontSize: '15px'}}>
          <li>Toca el candado (🔒) junto a la dirección del sitio web.</li>
          <li>Selecciona <strong>Permisos</strong>.</li>
          <li>Activa la opción de <strong>Notificaciones</strong>.</li>
        </ol>
        <strong style={{display: 'block', marginTop: '20px'}}>En Safari (iPhone):</strong>
        <ol style={{paddingLeft: '20px', fontSize: '15px'}}>
          <li>Toca el ícono 'AA' junto a la dirección del sitio web.</li>
          <li>Selecciona <strong>Configuración del sitio web</strong>.</li>
          <li>Activa los permisos de <strong>Notificaciones</strong>.</li>
        </ol>
